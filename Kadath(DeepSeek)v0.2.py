...
# -*- coding: utf-8 -*-
"""
KADATH v3.1 — La Búsqueda Onírica de la Desconocida Kadath
...
VERSION, STUDIO = "3.1", "Molvic Studio © 2024"
MAX_INV = 12
VEL_BASE = 10
...
# ═══════════════════════════════════════════════════════════════════════════════
# DATOS DEL JUEGO (sin campo 'peso')
# ═══════════════════════════════════════════════════════════════════════════════
ARMAS = {
...
ENEMIGOS = {
    ...
    "nightgaunt": Enemy(
        "nightgaunt", "Nightgaunt", 40, 40, 12, 22, "ONIRICO", 4, 16, 88, 8, 20, []
    ),
    "guardian": Enemy(
        "guardian",
        "Guardián de Leng",
...
QUESTS = {
    "q01": Quest(
        "q01",
        "El Favor de los Gatos",
        "menes",
        "zona_1",
        "Encuentra a Whisper",
        {"tipo": "tener", "item": "gatito_onirico"},
        {"oro": 50, "xp": 80, "flag": "GATOS_ALIADOS"},
    ),
    "q02": Quest(
        "q02",
        "El Trato de los Zoog",
        "zoog",
        "zona_2",
        "Entrega el gatito a los Zoog",
        {"tipo": "entregar", "item": "gatito_onirico"},
        {"oro": 30, "xp": 60, "item": "mapa_frag"},
    ),
    "q03": Quest(
        "q03",
        "La Deuda de Dylath",
        "arash",
        "zona_3",
        "Consigue un fragmento de cerámica",
        {"tipo": "tener", "item": "trofeo_ghast"},
        {"oro": 100, "xp": 100, "flag": "RUTA_SEGURA"},
    ),
}
...
ZONAS = {
    "zona_1": {
        ...
        "segura": True,
        "posada": True,
        "desc": "La ciudad donde ningún hombre puede matar a un gato.",
        "ascii": """
    /\\     /\\      ╔══════════════════════╗
   /  \\___/  \\     ║     ~ ULTHAR ~       ║
 ...
 /      Y      \\   ╚══════════════════════╝""",
    ...
    "zona_2": {
        ...
        "segura": False,
        "posada": False,
        "desc": "El Bosque Encantado donde los Zoog acechan entre las sombras.",
        "ascii": """
      , - ~ ~ ~ - ,     ╔═════════════════════╗
  , '   /\\     /\\   ' , ║  BOSQUE DE LOS ZOOG ║
 ,    /    \\ /    \\    ,╚═════════════════════╝""",
    ...
    "zona_3": {
        ...
        "segura": True,
        "posada": True,
        "desc": "El puerto oscuro de muelles de basalto negro.",
        "ascii": """
         |    |    |      ╔══════════════════╗
        )_)  )_)  )_)     ║   DYLATH-LEEN    ║
       )___))___))___)    ╚══════════════════╝""",
    ...
    "zona_4": {
        "nombre": "Montañas Humo",
        "segura": False,
        "posada": False,
        "desc": "Picos envueltos en vapores sulfurosos donde merodean los Gules.",
        "ascii": """
         /\\                ╔═══════════════════╗
        /  \\    /\\         ║ MONTAÑAS DEL HUMO ║
       /    \\  /  \\  /\\    ╚═══════════════════╝""",
    ...
    "zona_5": {
        "nombre": "Catacumbas Zak",
        "segura": False,
        "posada": False,
        "desc": "Laberinto de huesos bajo la tierra.",
        "ascii": """
  ╔═══╗ ╔═══╗ ╔═══╗   ╔══════════════════╗
  ║ ☠ ║ ║ ☠ ║ ║ ☠ ║   ║ CATACUMBAS ZAK   ║
  ╚═══╝ ╚═══╝ ╚═══╝   ╚══════════════════╝""",
    ...
    "zona_6": {
        ...
        "segura": True,
        "posada": True,
        "desc": "La ciudad maravillosa de torres de ónice bajo cielos eternos.",
        "ascii": """
       ╔═══╗   ╔═══╗      ╔══════════════════╗
      ╔╝   ╚═══╝   ╚╗     ║    CELEPHAÏS     ║
     ╔╝  ◇     ◇    ╚╗    ╚══════════════════╝""",
    ...
    "zona_7": {
        ...
        "segura": False,
        "posada": False,
        "desc": "Aguas misteriosas que conectan los reinos del sueño.",
        "ascii": """
   ~  ~  ~  ~  ~  ~  ~    ╔══════════════════╗
 ~    ⛵    ~    ~    ~   ║    MAR ORIAB     ║
~  ~  ~  ~  ~  ~  ~  ~  ~ ╚══════════════════╝""",
    ...
    "zona_8": {
        ...
        "segura": False,
        "posada": False,
        "desc": "La ciudad de ónice, última parada antes de Leng.",
        "ascii": """
  ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓   ╔══════════════════╗
  ▓  ╔════════╗   ▓   ║     INQUANOK     ║
  ▓  ║ ÓNICE  ║   ▓   ╚══════════════════╝""",
    ...
    "zona_9": {
        ...
        "segura": False,
        "posada": False,
        "desc": "Tierra prohibida donde la realidad se desmorona.",
        "ascii": """
  ▲       ▲       ▲    ╔══════════════════╗
 /█\\     /█\\     /█\\   ║   MESETA LENG    ║
/███\\   /███\\   /███\\  ╚══════════════════╝""",
        ...
        "npcs": [],
        "tienda": False,
        "encuentros": [("sacerdote", 0.3), ("guardian", 0.1)],
        "objetos": [],
    },
    "zona_10": {
        "nombre": "Kadath",
        "segura": False,
        "posada": False,
        "desc": "La Desconocida Kadath. El destino de tu búsqueda.",
        "ascii": """
        ★  ★  ★  ★  ★     ╔══════════════════╗
       ★ ╔══════════╗ ★  ║      KADATH      ║
      ★ ╔╝  ☆☆☆☆  ╚╗ ★  ╚══════════════════╝""",
...
TIENDA_CATALOGO = {
    ...
    "zona_6": ["cetro_ngranek", "armadura_gato", "elixir_voluntad"],
}
...
class Combat:
    ...
    def _dibujar(self):
        ...
        # Jugador (cuadro debajo)
        y += 6
        self.ui.caja(y, x_izq, 6, ancho_caja, "RANDOLPH CARTER")
        ...
        self.ui.addstr(y + 4, x_izq + 2, f"Arma: {self.p.arma.nombre[: ancho_caja - 10]}")
        ...
        self.ui.addstr(
            y,
            2,
            "[1] Atacar  [2] Usar Objeto  [3] Esquivar  [4] Huir",
            self.ui.col(4),
        )
    ...
    def _turno_jugador(self) -> Optional[str]:
        ...
        if k == ord("1"):
            ...
            # Mostrar consumibles disponibles
...
class Game:
    ...
    def _menu(self):
        ...
        opts = ["[N] Nueva Partida", "[C] Continuar", "[S] Salir"]
        y += 4
        for o in opts:
    ...
    def _explorar(self):
        # Si llegó a Kadath, final del juego
    ...
    def _dibujar_explor(self, z: dict):
        ...
        # HUD derecha (posición fija desde el borde derecho)
        hx = self.ui.mx - 22
        ...
        y += 1
        self.ui.addstr(
            y, 2, "[I] Inventario  [M] Mapa  [P] Pausa  [Q] Quests  [?] Ayuda"
        )
    ...
    def _dialogo_zoog(self):
        ...
        # Ofrecer misión q02 si no está completada ni activa
        if (
            "q02" not in self.p.quests_activas
            and "q02" not in self.p.quests_completas
        ):
        ...
        if k == ord("1"):
            ...
            # Si la misión no está activa, activarla
    ...
    def _decision_gatito(self):
        ...
        while True:
            ...
            if k == ord("1"):
                ...
                # Si la misión q02 estaba activa, la quitamos (no se completa)
                ...
                self.p.rem_item("gatito_onirico")
                # Completar q02 si estaba activa
                if "q02" in self.p.quests_activas:
                    self.p.quests_activas.remove("q02")
    ...
    def _inventario(self):
        while True:
            ...
            if self.p.arma:
                self.ui.addstr(
                    y, 4, f"Arma: {self.p.arma.nombre} ({self.p.arma.dmin}-{self.p.arma.dmax})"
                )
                y += 1
            if self.p.armadura:
                self.ui.addstr(
                    y, 4, f"Armadura: {self.p.armadura.nombre} (D:{self.p.armadura.defensa})"
                )

            self.ui.addstr(
                self.ui.my - 3, 2, "[E] Equipar  [U] Usar  [D] Descartar  [X] Cerrar"
            )
            self.ui.refresh()
    ...
    def _equipar(self):
        ...
        if ord("1") <= k <= ord("9"):
            ...
            if idx < len(self.p.inventario):
                ...
                if it.tipo == "ARMA":
                    # Verificar espacio antes de desequipar
                    if self.p.arma and self.p.arma.id != "punos":
                        if len(self.p.inventario) >= MAX_INV:
                            self.ui.addstr(
                                self.ui.my - 1, 2, "¡Inventario lleno! No puedes cambiar.",
                                self.ui.col(5)
                            )
                            self.ui.refresh()
                            time.sleep(1)
    ...
    def _final(self):
        ...
        if self.p.cordura <= 0:
            self.ui.caja(3, 5, 10, 65, "FINAL: DEVORADO POR EL CAOS")
            self.ui.addstr(6, 10, "Tu cordura se ha desvanecido.")
            self.ui.addstr(7, 10, "Nyarlathotep reclama tu alma.")
        elif self.p.zona == "zona_10":
            if self.p.cordura > 70 and self.p.flags.get("GATOS_ALIADOS"):
                self.ui.caja(3, 5, 10, 65, "FINAL: LA APOTEOSIS DEL SOÑADOR")
                self.ui.addstr(6, 10, "Has alcanzado Kadath y comprendido su secreto.")
            else:
                self.ui.caja(3, 5, 10, 65, "FINAL: EL DESPERTAR")
                self.ui.addstr(6, 10, "Llegaste a Kadath pero no como esperabas.")
        else:
            self.ui.caja(3, 5, 10, 65, "FIN DEL VIAJE")
            self.ui.addstr(6, 10, "Tu búsqueda ha terminado.")
    ...
    def _quests(self):
        ...
        if not self.p.quests_activas:
            ...
            for qid in self.p.quests_activas:
                q = QUESTS.get(qid)
                if q:
                    self.ui.addstr(y, 4, f"• {q.titulo}", self.ui.col(4))
                    y += 1
    ...
    def _ayuda(self):
        ...
        ayuda = [
            ...
            "",
            "CONSEJOS:",
            "• Explora para encontrar objetos",
            "• Habla con NPCs para quests",
            "• Gestiona tu Cordura",
            "• Descansa en zonas seguras",
            "",
            f"v{VERSION} - {STUDIO}",
        ]
...
# ═══════════════════════════════════════════════════════════════════════════════
# KADATH v3.1 — Molvic Studio © 2024
# Basado en "La Búsqueda Onírica de la Desconocida Kadath" de H.P. Lovecraft
# ═══════════════════════════════════════════════════════════════════════════════
# INSTALACIÓN: chmod +x kadath.py && python3 kadath.py
# CONTROLES: [1-9] Acciones | [I]nv [M]apa [P]ausa [Q]uests [?]Ayuda
# SAVES: ~/.kadath_saves/
# ═══════════════════════════════════════════════════════════════════════════════